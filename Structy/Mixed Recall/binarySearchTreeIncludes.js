...
//   const leftTreeIncludes = binarySearchTreeIncludes(root.left, target)
//   const rightTreeIncludes = binarySearchTreeIncludes(root.right, target)
//   if(leftTreeIncludes || rightTreeIncludes){
//     return true
//   } else {
//     return false
//   }
...
//depth first recursive optimized
//n = number of nodes
//worst case
//time: O(n)
//space: O(n)
